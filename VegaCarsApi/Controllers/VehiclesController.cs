...
using VegaCarsApi.Models;

namespace VegaCarsApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class VehiclesController : ControllerBase
    {
        private readonly VegaCarsContext _context;

        public VehiclesController(VegaCarsContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Vehicle>> PostVehicle(Vehicle vehicle)
        {
          if (_context.Vehicles == null)
          {
              return Problem("Entity set 'VegaCarsContext.Vehicles'  is null.");
          }
